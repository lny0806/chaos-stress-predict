import models
import torch
from data import StressDataTwo
...
def train_karry():
    ...
    model.to(device)
    train_data = StressDataTwo(opt.train_data_root,opt)
    test_data = StressDataTwo(opt.test_data_root,opt)
    ...
    weight_CE = torch.FloatTensor([4,1])
